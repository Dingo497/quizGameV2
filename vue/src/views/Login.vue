...
<div>
  <div>
    ...
    <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Sign in to your account - LOGIN</h2>
    <p class="mt-2 text-center text-sm text-gray-600">
      Or
      <router-link :to="{name: 'Register'}" class="font-medium text-indigo-600 hover:text-indigo-500">Register now</router-link>
    </p>
  </div>
